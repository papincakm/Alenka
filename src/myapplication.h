...
public:
  ...
  static auto version() { return std::array<int, 3>{{3, 0, 0}}; }
  ...
  static QDir makeQtAppSubdir(const std::vector<QString> &relPath);

  static QDir makeCustomAppSubdir(const std::string& appdir, const std::vector<QString> &relPath);
};
